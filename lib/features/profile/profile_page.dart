      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _RecurringEntry(count: profile.recurringOrders.length),
            const SizedBox(height: 12),
...
class _RecurringEntry extends StatelessWidget {
  const _RecurringEntry({required this.count});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          strings.recurringOrdersPageTitle,
          style: theme.textTheme.titleMedium,
        ),
        subtitle: Text(
          strings.recurringEntrySummary(count),
          maxLines: 2,
          overflow: TextOverflow.ellipsis,
        ),
        trailing: const Icon(Icons.chevron_right),
